...
public class MathCalculator {
    ...
    public double computeFactorial(double inp) {
        double result = fact(inp);
        return result;
    }
    
    
    public double computeSquareRoot(double inp) {
        double result = Math.sqrt(inp);
        return result;
    }
    
    
    public double computePower(double inp1, double inp2) {
        double result = Math.pow(inp1,inp2);
        return result;
    }
    
    public double computeNaturalLog(double inp) {
        double result = 0;
        try {
